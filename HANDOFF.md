...
> Tarih: 2026-08-28 · Durum: **Faz 0–4B tamamlandı, master'da (PR #1–#24 merge), CI yeşil, CANLI.** Neon (Frankfurt) + Vercel (Hobby). Son sprint (PR #13–#24): koç modülü iyileştirmeleri, Mi Scale 2 BLE düzeltmeleri, dashboard gerçek kalori, antrenman dedup güçlendirme (±5dk tüm kaynaklar), zamana göre selamlama.
