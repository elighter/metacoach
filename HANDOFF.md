...
> Tarih: 2026-08-28 · Durum: **Faz 0–4B tamamlandı, master'da (PR #1–#25 merge), CI yeşil, CANLI.** Neon (Frankfurt) + Vercel (Hobby). Son sprint (PR #13–#25): koç modülü iyileştirmeleri, Mi Scale 2 BLE düzeltmeleri, dashboard gerçek kalori, antrenman dedup güçlendirme, zamana göre selamlama, **antrenman senkron teşhisi** (`HealthIngestLog` + HAE 2-otomasyon düzeltmesi).
> ⚠️ **Kullanıcı aksiyonu bekleyen:** HAE'de **2. otomasyon (Workouts)** kurulmalı — yoksa antrenmanlar akmaz. Ayarlar → Apple Health → "Son senkronlar" panelinde uyarı görünür.
