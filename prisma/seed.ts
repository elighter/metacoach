...
async function main() {
  ...
  await prisma.coachInvite.create({
    data: {
      clientId: user.id,
      code: `DEMO${Date.now().toString(36).slice(-6).toUpperCase()}`,
